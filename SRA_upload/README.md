...
For the sample name, provide a short name that describes the sample, such as `Adimab_MAP_barcodes`.
...
Finally, add a sample title, such as "Illumina barcode sequencing from mutational antigenic profiling of Adimab Omicron breakthrough mAbs"
Then hit `Continue`, make sure everything looks correct, then hit `Submit`.

After a brief bit of processing, the *BioSample* submission should show up, along with a sample accession: *SAMN34380495*.
