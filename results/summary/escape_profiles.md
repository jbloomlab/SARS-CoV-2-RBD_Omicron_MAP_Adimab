...
```
    ...
    bind ranges from -2.49653 to 0.0, here is the scale bar, which is being saved to results/escape_profiles/bind_scalebar_horizontal.pdf
...
![png](escape_profiles_files/escape_profiles_18_1.png)
    ...
    bind ranges from -2.49653 to 0.0, here is the scale bar, which is being saved to results/escape_profiles/bind_scalebar_vertical.pdf
...
![png](escape_profiles_files/escape_profiles_18_3.png)
    ...
    expr ranges from -0.9978 to 0.0, here is the scale bar, which is being saved to results/escape_profiles/expr_scalebar_horizontal.pdf
...
![png](escape_profiles_files/escape_profiles_18_5.png)
    ...
    expr ranges from -0.9978 to 0.0, here is the scale bar, which is being saved to results/escape_profiles/expr_scalebar_vertical.pdf
...
```
    ...
    Plotted profile 1 to:
     results/escape_profiles/Adimabs_stackedlogo.pdf
     results/escape_profiles/Adimabs_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_1.png)
    ...
    Plotted profile 2 to:
     results/escape_profiles/Adimabs_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Adimabs_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_3.png)
    ...
    Plotted profile 3 to:
     results/escape_profiles/Adimabs_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Adimabs_color_by_expr_stackedlogo.png.
